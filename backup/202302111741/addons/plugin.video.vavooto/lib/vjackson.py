# -*- coding: utf-8 -*-
import sys, xbmc, xbmcvfs, os, json, requests, urllib3, utils
...
def prepareListItem(params, e):
	...
	art = {'icon': e.get('poster', 'special://home/addons/plugin.video.vavooto/icon.png'), 'thumb': e.get('poster', 'special://home/addons/plugin.video.vavooto/icon.png'), 'poster': e.get('poster', 'special://home/addons/plugin.video.vavooto/icon.png'), 'banner': e.get('backdrop', 'special://home/addons/plugin.video.vavooto/icon.png')}
...
def addDir(name, url, iconimage="DefaultFolder.png", isFolder=True, isPlayable=False):
    iconimage = "special://home/addons/plugin.video.vavooto/icon.png"
    liz = ListItem(name)
